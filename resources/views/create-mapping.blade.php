          ...
          <form action="api/add-mapping" method="post">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" name="api_headers" id="api_headers" class="form-control" placeholder="Api Headers">
                </div>
              </div>  

              <div class="form-row">
                <div class="form-group col-md-8">
                  <label for="inputPassword">Test API Endpoint</label>
                  <input type="text" name="api_endpoint_test" id="api_endpoint_test" class="form-control" placeholder="Exact API Endpoint">
                </div>
              </div> 
...
function getApiResponseKeys(callback) {
    var api_endpoint_test = document.getElementById('api_endpoint_test').value;
    var api_headers = document.getElementById('api_headers').value;

    $.ajax({
      url : '/api/get-api-key-pairs?api='+btoa(api_endpoint_test)+'&headers='+btoa(api_headers),
      type: "get",
      dataType: "json",
      success: function(resp) {
        var options = "";
